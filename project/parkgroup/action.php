<?php
	...
	if($_POST['user_text'] == "") 	 $errors[] = "Поле 'сообщение' не заполнено!";
	...
	if(empty($errors)){		
		...
		<caption style='margin-bottom: 15px;font-size: 21px;color: #37b178;'>Вам пришла заявка с сайта Avrora </caption> 
			...
			$message .= "
				<td> 
					<p style='padding: 8px;border-bottom: 1px solid #ccc;'>Сообщение:</p> 
					<p style='color:#1f22b4; font-size: 20px; padding: 8px;'>" . $_POST['user_text'] . "</p> 
				<td>";
/*			$message .= "
				<td> 
